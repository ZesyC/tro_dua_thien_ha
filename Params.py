...
def ParseArgs():
	...
	# Consistency Model
	parser.add_argument('--use_consistency', type=int, default=0, help='0: GaussianDiffusion, 1: ConsistencyModel')
	parser.add_argument('--cm_sigma_min', type=float, default=0.002, help='min noise level (epsilon)')
	parser.add_argument('--cm_sigma_max', type=float, default=1.0, help='max noise level (tunable per dataset)')
	parser.add_argument('--cm_N_min', type=int, default=10, help='initial discretization steps')
